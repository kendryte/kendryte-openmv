...
#else
#define IM_SWAP16(x) (((x & 0xff) << 8) | ((x & 0xff00) >> 8))
#define IM_SWAP32(x) (((x & 0xff) << 24) | ((x & 0xff00) << 8) | ((x & 0xff0000) >> 8) | ((x & 0xff000000) >> 24))
#endif
...
void imlib_lens_corr(image_t *img, float strength, float zoom_in);
