...
#define OMV_FIRMWARE_VERSION_MAJOR      (3)
#define OMV_FIRMWARE_VERSION_MINOR      (2)
#define OMV_FIRMWARE_VERSION_PATCH      (0)

/*Should be replaced by CPUID*/
#define OMV_BOARD_ID_MAJOR              (0x20181102)
#define OMV_BOARD_ID_MINOR              (0x210bd)
#define OMV_BOARD_ID_PATCH              (0x00000001)
